...
Audited September 2, 2026. Hyphenated terms, numbers, and the version string count as one word. Dynamic contract names follow the listed patterns. No sentence exceeds 22 words, and no banned marketing term appears.
...
| Named client, product, and 20, 23, or 27 units | 9 | Dynamic pattern; pass |
| How it works | 3 | Pass |
...
| Concept | Term used |
| --- | --- |
| Whole six-chapter game | campaign |
| One timed production attempt | shift |
| Ordered machine layout | route |
| Customer target | contract |
| Non-persistent sample mode | demo |
| Downloaded and restored progress | campaign record |
| Optional future content | bonus contracts |
